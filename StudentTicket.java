...
/**
 * Represents a ticket for a student. A transaction can have multiple student
 * tickets. StudentTicket implements the ticketInterface. The price of the
 * student ticket is based on the day of the week, cinema class and whether it
 * is 2D or 3D.
 * 
 ...
 * @since 2019-11-14
 */
public class StudentTicket implements TicketInterface {
	/**
	...
	/**
	 * The price of the student movie ticket
	 */
	private double price;

	/**
	 * Get the name of the movie that the user is buying
	 * 
	...
	/**
	 * Creates a new StudentTicket with the given movie name, movie rating, type of
	 ...
	 */
	public StudentTicket(String name, String PGRating, String typeofMovie, String classofCinema, String timing,
			String movieDay, String hall, String seat, String transactionID, double price) {
		this.name = name;
		this.PGRating = PGRating;
		StudentTicket.typeofMovie = typeofMovie;
		StudentTicket.classofCinema = classofCinema;
		this.timing = timing;
	 ...
	 *               made
	 */
	public static void printTicket(StudentTicket ticket) {
		System.out.println(
				"Title: " + ticket.getName() + " " + ticket.getPGRating() + "(" + StudentTicket.gettypeofMovie() + ")");
		System.out.println("Date: " + ticket.getmovieDay());
		System.out.println("Timing: " + ticket.gettiming());
		System.out.println("Cinema: " + StudentTicket.getclassofCinema());
	...
	/**
	 * Get the price of a student ticket for a 2D movie on a weekday for Cathay
	 * class
	 * 
	 * @param pricesAL This is an array list containing the various combination of
	 *                 prices.
	 * @return returns the price of the student ticket
	 */
	public static String getCathay2DWeekdayChild(ArrayList<TicketMgr> pricesAL) {
		double amount ;
		String strAmt = null ; 
		for (int k = 0; k < pricesAL.size(); k++) {
			TicketMgr TicketMgr = (TicketMgr) pricesAL.get(k);

			if (TicketMgr.getdayofWeek().equals("Weekdays") && TicketMgr.getageofmovieGoer().equals("Student")
	...
	/**
	 * Get the price of a student ticket for a 2D movie on a weekend for Cathay
	 * class
	 * 
	 * @param pricesAL This is an array list containing the various combination of
	 *                 prices.
	 * @return returns the price of the student ticket
	 */
	public static String getCathay2DWeekendChild(ArrayList<TicketMgr> pricesAL) {
		...
		for (int k = 0; k < pricesAL.size(); k++) {
			...
			if (TicketMgr.getdayofWeek().equals("Weekends") && TicketMgr.getageofmovieGoer().equals("Student")
					&& TicketMgr.getclassofCinema().equals("Cathay") && TicketMgr.gettypeofMovie().equals("2D")) {
				amount = TicketMgr.getprice();
				DecimalFormat con = new DecimalFormat("#.00");
			   strAmt = con.format(amount);
	...
	/**
	 * Get the price of a student ticket for a 3D movie on a weekday for Cathay
	 * class
	 * 
	 * @param pricesAL This is an array list containing the various combination of
	 *                 prices.
	 * @return returns the price of the student ticket
	 */
	public static String getCathay3DWeekdayChild(ArrayList<TicketMgr> pricesAL) {
	...
	/**
	 * Get the price of a student ticket for a 3D movie on a weekend for Cathay
	 * class
	 * 
	 * @param pricesAL This is an array list containing the various combination of
	 *                 prices.
	 * @return returns the price of the student ticket
	 */
	public static String getCathay3DWeekendChild(ArrayList<TicketMgr> pricesAL) {
	...
	/**
	 * Get the price of a student ticket for a 2D movie on a weekday for Platinum
	 * class
	 * 
	 * @param pricesAL This is an array list containing the various combination of
	 *                 prices.
	 * @return returns the price of the student ticket
	 */
	public static String getPlat2DWeekdayChild(ArrayList<TicketMgr> pricesAL) {
	...
	/**
	 * Get the price of a student ticket for a 2D movie on a weekend for Platinum
	 * class
	 * 
	 * @param pricesAL This is an array list containing the various combination of
	 *                 prices.
	 * @return returns the price of the student ticket
	 */
	public static String getPlat2DWeekendChild(ArrayList<TicketMgr> pricesAL) {
	...
	/**
	 * Get the price of a student ticket for a 3D movie on a weekday for Platinum
	 * class
	 * 
	 * @param pricesAL This is an array list containing the various combination of
	 *                 prices.
	 * @return returns the price of the student ticket
	 */
	public static String getPlat3DWeekdayChild(ArrayList<TicketMgr> pricesAL) {
	...
	/**
	 * Get the price of a student ticket for a 3D movie on a weekend for Platinum
	 * class
	 * 
	 * @param pricesAL This is an array list containing the various combination of
	 *                 prices.
	 * @return returns the price of the student ticket
	 */
	public static String getPlat3DWeekendChild(ArrayList<TicketMgr> pricesAL) {
