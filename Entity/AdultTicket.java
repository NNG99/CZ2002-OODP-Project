...
/**
 * Represents a ticket for an Adult. A transaction can have multiple adult
 * tickets. AdultTicket implements the ticketInterface. The price of the adult
 * ticket is based on the day of the week, cinema class and whether it is 2D or
 * 3D.
 * 
 ...
 * @since 2019-11-14
 */
public class AdultTicket implements TicketInterface {
	/**
	 * The name of the movie that the user wishes to purchase
	 */
	private String name;
	/**
	...
	/**
	 * The type of movie that the user wishes to purchase
	 */
	private static String typeofMovie;
	/**
	 * The class of cinema that the user wishes to purchase
	 */
	private static String classofCinema;
	/**
	 * The timing of the movie that the user wishes to purchase
	 */
	private String timing;
	/**
	 * The day of the week of the movie that th user wishes to purchase
	 */
	...
	private String seat;
	/**
	 * The transaction ID of that purchase
	 */
	private String transactionID;
	/**
	 * The price of the adult movie ticket
	 */
	private static double price;

	/**
	 * Get the name of the movie that the adult is buying
	 * 
	...
	/**
	 * Get the rating of the movie that user is buying
	 * 
	...
	/**
	 * Creates a new AdultTicket with the given movie name, movie rating, type of
	 ...
	 */
	public AdultTicket(String name, String PGRating, String typeofMovie, String classofCinema, String timing,
			String movieDay, String hall, String seat, String transactionID, double price) {
		this.name = name;
		this.PGRating = PGRating;
		AdultTicket.typeofMovie = typeofMovie;
		AdultTicket.classofCinema = classofCinema;
		this.timing = timing;
	 ...
	 *               made
	 */
	public static void printTicket(AdultTicket ticket) {
		System.out.println(
				"Title: " + ticket.getName() + " " + ticket.getPGRating() + "(" + AdultTicket.gettypeofMovie() + ")");
		System.out.println("Date: " + ticket.getmovieDay());
		System.out.println("Timing: " + ticket.gettiming());
		System.out.println("Cinema: " + AdultTicket.getclassofCinema());
		System.out.println(ticket.gethall());
		System.out.println("Seat(s): " + ticket.getSeat());
		System.out.println("Price: " + AdultTicket.getPrice());
		System.out.println("Transaction ID: " + ticket.gettransactionID());
		System.out.println();
	}

	/**
	 * Get the price of an adult ticket for a 2D movie on a weekday for Cathay class
	 * 
	 * @param pricesAL This is an array list containing the various combination of
	 *                 prices.
	 * @return returns the price of the adult ticket
	 */
	public static String getCathay2DWeekdayAdult(ArrayList<TicketMgr> pricesAL) {
		double amount ;
		String strAmt = null ; 
		for (int k = 0; k < pricesAL.size(); k++) {
			TicketMgr TicketMgr = (TicketMgr) pricesAL.get(k);

			if (TicketMgr.getdayofWeek().equals("Weekdays") && TicketMgr.getageofmovieGoer().equals("Adult")
	...
	/**
	 * Get the price of an adult ticket for a 2D movie on a weekend for Cathay class
	 * 
	 * @param pricesAL This is an array list containing the various combination of
	 *                 prices.
	 * @return returns the price of the adult ticket
	 */
	public static String getCathay2DWeekendAdult(ArrayList<TicketMgr> pricesAL) {
		double amount ;
		String strAmt = null ; 
		for (int k = 0; k < pricesAL.size(); k++) {
			TicketMgr TicketMgr = (TicketMgr) pricesAL.get(k);

			if (TicketMgr.getdayofWeek().equals("Weekends") && TicketMgr.getageofmovieGoer().equals("Adult")
					&& TicketMgr.getclassofCinema().equals("Cathay") && TicketMgr.gettypeofMovie().equals("2D")) {
				amount = TicketMgr.getprice();
				DecimalFormat con = new DecimalFormat("#.00");
			   strAmt = con.format(amount);
	...
	/**
	 * Get the price of an adult ticket for a 3D movie on a weekday for Cathay class
	 * 
	 * @param pricesAL This is an array list containing the various combination of
	 *                 prices.
	 * @return returns the price of the adult ticket
	 */
	public static String getCathay3DWeekdayAdult(ArrayList<TicketMgr> pricesAL) {
	...
	/**
	 * Get the price of an adult ticket for a 3D movie on a weekend for Cathay class
	 * 
	 * @param pricesAL This is an array list containing the various combination of
	 *                 prices.
	 * @return returns the price of the adult ticket
	 */
	public static String getCathay3DWeekendAdult(ArrayList<TicketMgr> pricesAL) {
	...
	/**
	 * Get the price of an adult ticket for a 2D movie on a weekday for Platinum
	 * class
	 * 
	 * @param pricesAL This is an array list containing the various combination of
	 *                 prices.
	 * @return returns the price of the adult ticket
	 */
	public static String getPlat2DWeekdayAdult(ArrayList<TicketMgr> pricesAL) {
	...
	/**
	 * Get the price of an adult ticket for a 2D movie on a weekend for Platinum
	 * class
	 * 
	 * @param pricesAL This is an array list containing the various combination of
	 *                 prices.
	 * @return returns the price of the adult ticket
	 */
	public static String getPlat2DWeekendAdult(ArrayList<TicketMgr> pricesAL) {
	...
	/**
	 * Get the price of an adult ticket for a 3D movie on a weekday for Platinum
	 * class
	 * 
	 * @param pricesAL This is an array list containing the various combination of
	 *                 prices.
	 * @return returns the price of the adult ticket
	 */
	public static String getPlat3DWeekdayAdult(ArrayList<TicketMgr> pricesAL) {
		double amount ;
		String strAmt = null ; 
		for (int k = 0; k < pricesAL.size(); k++) {
			TicketMgr TicketMgr = (TicketMgr) pricesAL.get(k);
	...
	/**
	 * Get the price of an adult ticket for a 3D movie on a weekend for Platinum
	 * class
	 * 
	 * @param pricesAL This is an array list containing the various combination of
	 *                 prices.
	 * @return returns the price of the adult ticket
	 */
	public static String getPlat3DWeekendAdult(ArrayList<TicketMgr> pricesAL) {
